...
import AddEngineer from './components/Layout/Navbar/Engineer/AddEngineer/AddEngineer';
import Stores from './components/Layout/Navbar/Stores/Stores';
import AddStore from './components/Layout/Navbar/Stores/AddStore/AddStore'
...
const Router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "navbar" , element: <Navbar /> ,children : [
        ...
        { path: "stores/addstores", element: <AddStore/> },
        { path: "navbar", element: <Clients /> },
        { path: "profile", element: <Profile/> },
        { path: "clients", element: <Clients /> },
        { path: "engineer", element: <Engineer /> },
        { path: "engineer/addEngineer",  element: <AddEngineer /> },
        { path: "engineerrequests/engineerRequestDesc" ,element : <EngineerRequestDesc/>},
        { path: "engineerrequests", element: < Engineerrequests/> },
        { path: "storesrequests", element: <Storesrequests /> },
        { path: "storesrequests/storeRequestDesc", element: <StoreRequestDesc /> },
